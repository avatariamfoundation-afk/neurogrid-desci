...
1. **Proportionality** – Sanctions match severity and impact  
2. **Due Process** – Evidence-based, documented decisions  
3. **Safety Priority** – Patient and system safety override all interests  
4. **Non-Retaliation** – Protection for reporters and investigators  
5. **Remediation First** – Correction is mandatory, not optional  
...
5. Governance or safety council determination
6. Formal sanction resolution and documentation
